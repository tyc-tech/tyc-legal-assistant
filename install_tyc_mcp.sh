#!/bin/bash
# tyc-legal-assistant Installation Script · 一键安装 / Installation
#
# 用法 / Usage:
#   curl 模式（推荐） / curl mode (recommended):
#     bash <(curl -sL https://raw.githubusercontent.com/tyc-tech/tyc-legal-assistant/main/install_tyc_mcp.sh)
#
#   本地模式 / local mode:
...
echo "  天眼查 OpenAPI MCP · 法务 / 合规 8 SKILL"
echo "=========================================="
echo ""
